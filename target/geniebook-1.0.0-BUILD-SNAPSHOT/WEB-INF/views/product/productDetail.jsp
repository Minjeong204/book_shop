...
<div class="container">
	<div class="row">
		<div class="col-sm-9 padding-right">
			...
			<!--/product-details-->
			<div class="category-tab shop-details-tab" id="reviews">
				<!--category-tab-->
				<script type="text/javascript">
					function detail() {
				...
				<div class="col-sm-12">
					<ul style="background-color: #ffa500" class="nav nav-tabs">
						<li class="active"><a href="#details" onclick="detail()" data-toggle="tab">Details</a></li>
								...
								<div class="box box-primary">
									...
									<div class="box-body">
										...
										<c:if test="${pageContext.request.userPrincipal.name == null}">
											<label> <a href="${contextPath }/login">로그인</a> 하셔야
												댓글을 작성할 수 있습니다.
											</label>
										</c:if>
									</div>
